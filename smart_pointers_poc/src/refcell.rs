//! Implementing `RefCell<T>` per <https://www.youtube.com/watch?v=8O0Nt9qY_vo&t=2484s>
...
impl<T> std::ops::DerefMut for RefMut<'_, T> {
    fn deref_mut(&mut self) -> &mut Self::Target {
        // SAFETY: a RefMut is only created if no other exclusive references have been given out.
